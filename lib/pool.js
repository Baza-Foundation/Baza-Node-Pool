        ...
        function (portData, cback) {
            ...
            net.createServer(function (socket) {
                ...
                socket
                    .on("data", function (d) {
                        ...
                        if (Buffer.byteLength(dataBuffer, "utf8") > 10240) {
                            ...
                            log(
                                "warn",
                                logSystem,
                                "Socket flooding detected and prevented from the IP and banned %s",
                                [socket.remoteAddress]
                            );
                            process.send({
                                type: "permanentBanIP",
                            ...
                            for (var i = 0; i < messages.length; i++) {
                                ...
                                try {
                                    ...
                                    log(
                                        "warn",
                                        logSystem,
                                        "Malformed message from the IP and banned %s: %s",
                    ...
                    .on("connect", function () {
                        log("warn", logSystem, "Permanent : %s", [
                            permanentBannedIPs,
                        ]);
                        log("warn", logSystem, "Curr : %s", [
                            socket.remoteAddress,
                        ]);
                        if (
